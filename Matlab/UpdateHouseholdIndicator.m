function [z_HH_all, z_HH_Individuals_all,newphi] = UpdateHouseholdIndicator(n,n_individuals,maxd,p, K,L,...
    phi,dataT,SS,w,pi,HHdata_all,lambda1,lambda2,ImpossibleIndividuals,z_HH_extra)
    ...
    z_HH_prob = samplezHHwithHHnewv1_2HHvar(newphi,dataT,w,pi,SS',K,L,p,maxd,n,HHdata_all(1:n,1),lambda1,HHdata_all(1:n,2),lambda2);
    for h = 1:n
